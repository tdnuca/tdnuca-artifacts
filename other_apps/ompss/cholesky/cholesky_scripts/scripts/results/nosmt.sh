...
taskset -c 0-7 ../cholesky ${size} ${block_size} 0 file ${iter} > bf_${total}_${fast}.txt
...
taskset -c 0-5 ../cholesky ${size} ${block_size} 0 file ${iter} > bf_${total}_${fast}.txt
cpufreq-set -c 4 -f 2668000
fast=2
taskset -c 0-5 ../cholesky ${size} ${block_size} 0 file ${iter} > bf_${total}_${fast}.txt
...
taskset -c 0-3 ../cholesky ${size} ${block_size} 0 file ${iter} > bf_${total}_${fast}.txt
cpufreq-set -c 2 -f 2668000
fast=2
taskset -c 0-3 ../cholesky ${size} ${block_size} 0 file ${iter} > bf_${total}_${fast}.txt
...
total=1
fast=1
taskset -c 0-1 ../cholesky ${size} ${block_size} 0 file ${iter} > bf_${total}_${fast}.txt
#fi
fi
COMMENT1
#============================================================================
...
export NX_HP_FROM=7
export NX_HP_TO=7
./runSingle.sh "${size} ${block_size} 0 file ${iter}" 0-7 $1 $total $fast
...
export NX_HP_FROM=5
export NX_HP_TO=5
./runSingle.sh "${size} ${block_size} 0 file ${iter}" 0-5 $1 $total $fast
...
export NX_HP_FROM=3
export NX_HP_TO=3
./runSingle.sh "${size} ${block_size} 0 file ${iter}" 0-3 $1 $total $fast
...
export NX_HP_FROM=1
export NX_HP_TO=1
./runSingle.sh "${size} ${block_size} 0 file ${iter}" 0-1 $1 $total $fast
